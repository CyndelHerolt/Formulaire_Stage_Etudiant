...
class FormTypeStage extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('date_debtut_stage', DateType::class, ['label' => 'Date de début :','attr' => ['autocomplete'=>'off', 'class' => 'flatdatepicker'], 'widget' => 'single_text', 'html5' => false, 'format' => 'dd/MM/yyyy'
//                , 'constraints' => [new NotBlank(message: 'Veuillez renseigner ce champ')]
            ])

            ->add('date_fin_stage', DateType::class, ['label' => 'Date de fin  :','attr' => ['autocomplete'=>'off', 'class' => 'flatdatepicker'] ,
//                'constraints' => [new NotBlank(message: 'Veuillez renseigner ce champ')],
...
//                'constraints' => [new NotBlank(message: 'Veuillez renseigner ce champ')],
            ...
            ->add('duree_hebdomadaire', NumberType::class, ['label' => 'Durée de travail hebdomadaire :', 'attr' => ['autocomplete'=>'off', 'placeholder'=>'Exemple : 35']
//                ,'constraints' => [new NotBlank(message: 'Veuillez renseigner ce champ')]
            ])
...
//                'constraints' => [new NotBlank(message: 'Veuillez renseigner ce champ')],
                'attr' => ['autocomplete'=>'off', 'placeholder' => '3.9']])
