...
class EtudiantType extends AbstractType
{
    ...
    {
        $builder
            ->add('intituleSecuriteSociale', TextType::class, ['label' => 'Organisme de sécurité sociale * :', 'attr' => ['for' => 'nom de l\'organisme de sécurité soiale', 'autocomplete'=>'off'],
            ...
            ->add('mailPerso', EmailType::class, ['label' => 'Votre email personnel :', 'help' => 'l\'email doit être saisi sous la forme : xxxxxx@xxx.xxx.', 'attr' => ['autocomplete'=>'off'],
                'constraints' => [new NotBlank(message: 'Veuillez renseigner ce champ'), new Email(message: 'Veuillez renseigner un email valide')]
            ])

            ->add('tel2', TextType::class, ['label' => 'Votre numéro de téléphone :', 'help' => 'le numéro de téléphone doit comporter 10 chiffres.', 'attr' => ['autocomplete'=>'off'],
